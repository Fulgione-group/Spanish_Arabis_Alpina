...
df_cantabria_all_mut_p=df_cantabria_all_mut[df_cantabria_all_mut["polymorphism_substitution"]=="p"]
df_france_all_mut_p=df_france_all_mut[df_france_all_mut["polymorphism_substitution"]=="p"]
...
output=open("output_log_reg_df.tsv","w")
